...
//    CGFloat a = rgba[3] + rgbaGAP[3]*self.rate;
    if (_rate == 0.0) {
         self.dk_textColorPicker = DKColorWithColors(_normalColor, [UIColor colorWithHexString:NIGHT_NEWS_BODYTEXT]);
    }
    else {
       self.dk_textColorPicker = DKColorWithColors(_selectedColor, _selectedColor);
    }
